  ...
  return (
    <footer className="relative mt-auto border-t border-primary/20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6 max-w-5xl mx-auto">
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Icon container */}
                    <div className="relative w-10 h-10 bg-background/50 backdrop-blur-sm border border-primary/30 rounded-full flex items-center justify-center group-hover:border-primary/60 transition-all duration-300">
                      <Icon className={`w-4 h-4 text-muted-foreground ${social.hoverColor} transition-colors duration-300`} />
                    </div>
                  </motion.a>
                );
              })}
        ...
        <div className="relative h-[1px] bg-gradient-to-r from-transparent via-primary/30 to-transparent mb-4" />
